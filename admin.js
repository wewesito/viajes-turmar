...
const demoEvents = [
  { name: "page_view", label: "Visitas", count: 428 },
  { name: "search_started", label: "Busquedas", count: 126 },
  { name: "result_selected", label: "Resultados elegidos", count: 54 },
  { name: "proposal_requested", label: "Solicitudes", count: 23 },
  { name: "whatsapp_click", label: "WhatsApp", count: 17 },
];
...
const launchItems = [
  { title: "Dominio propio", status: "Pendiente" },
  { title: "Email profesional", status: "Pendiente" },
  ...
  { title: "CRM o base de datos", status: "Pendiente proveedor" },
  { title: "Pasarela de pago", status: "Pendiente banco/Stripe" },
];
